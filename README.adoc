...
* For normal change, please use "rewrite", "update", "delete" as the summary
prefix.
...
# breaking change
lib/crypto: !delete the SHA-1 library support
...
refactor::
This commit may change some part of the code. Here I copy the database "CRUD"
actions. The action create belong to new features so here we drop it.
I limit the refactor verbs to "Rewrite", "Update", "Delete".
